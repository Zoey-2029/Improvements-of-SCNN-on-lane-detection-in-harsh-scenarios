...
# from encoder_decoder_model import vgg_encoder_try as vgg_encoder_2
# from encoder_decoder_model import vgg_encoder
# from encoder_decoder_model import resnet_encoder

# from encoder_decoder_model import resnet_encoder_v2 as resnet_encoder_2
from encoder_decoder_model import resnet_encoder_v2_all as resnet_encoder_all
...
class LaneNet(cnn_basenet.CNNBaseModel):
    ...
    def inference(input_tensor, phase, name):
        ...
        with tf.variable_scope(name):
            with tf.variable_scope('inference'):
                ...
                # encoder = resnet_encoder.ResNetEncoder(phase=phase,res_n=18)
                encoder = resnet_encoder_all.ResNetEncoder(phase=phase,res_n=18)
    ...
    def loss(inference, binary_label, existence_label, name):
        ...
        with tf.variable_scope(name):
            ...
            #  decode_logits_reshape += tf.constant(1e-8)
            decode_logits_reshape = tf.sigmoid(decode_logits_reshape)
            ...
            class_weights = tf.constant([[0.05, 1.0, 1.0, 1.0, 1.0]])
