    ...
    def encode(self, input_tensor, name):
        ...
        with tf.variable_scope(name):
            ...
            pool1 = self.maxpooling(inputdata=conv_1_2, kernel_size=2,
                                    stride=2, name='pool1')
            print('1range', pool1.get_shape().as_list())
            # conv stage 2_1
            ...
            pool2 = self.maxpooling(inputdata=conv_2_2, kernel_size=2,
                                    stride=2, name='pool2')
            print('2range', pool2.get_shape().as_list())
            # conv stage 3_1
            ...
            pool3 = self.maxpooling(inputdata=conv_3_3, kernel_size=2,
                                    stride=2, name='pool3')
            print('3range', pool3.get_shape().as_list())
            # conv stage 4_1
            ...
            print('4range', conv_4_3.get_shape().as_list())
            ...
            print('5range', conv_5_5.get_shape().as_list())
            # add message passing #
