    ...
    def _init_dataset(self):
        ...
        with open(self.dataset_info_file, 'r') as file:
            for _info in file:
                ...
                img_list.append('../../../dataset/dataset'+info_tmp[0][0:])
                label_instance_list.append('../../../dataset/dataset'+info_tmp[1][0:])
                # img_list.append('dataset'+info_tmp[0][0:])
                # label_instance_list.append("dataset"+info_tmp[1][0:])
        ...
        with tf.name_scope('data_augmentation'):
            ...
            input_queue = tf.train.slice_input_producer([image_tensor, label_instance_tensor, label_existence_tensor], shuffle = True)
